...
class Eco(object):
    ...
    def __init__(self, json=None, **kwargs):
        ...
        self._traceback = client_support.set_property('_traceback', data, data_types, False, [], False, True, class_name)
        data_types = [string_types]
        ...
        data_types = [string_types]
        self.errormessage = client_support.set_property('errormessage', data, data_types, False, [], False, True, class_name)
        data_types = [string_types]
        self.errormessagePub = client_support.set_property('errormessagePub', data, data_types, False, [], False, True, class_name)
        data_types = [string_types]
        self.exceptionclassname = client_support.set_property('exceptionclassname', data, data_types, False, [], False, True, class_name)
        data_types = [string_types]
        self.funcfilename = client_support.set_property('funcfilename', data, data_types, False, [], False, True, class_name)
        data_types = [int]
        self.funclinenr = client_support.set_property('funclinenr', data, data_types, False, [], False, True, class_name)
        data_types = [string_types]
        ...
        data_types = [int]
        self.occurrences = client_support.set_property('occurrences', data, data_types, False, [], False, True, class_name)
        data_types = [int]
