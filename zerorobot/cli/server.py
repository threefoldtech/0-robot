...
@click.option('--config-key', '-K', required=False, help='path to the sshkey to use in the configuration repo. If not specified, try to use the key configure in jumspcale if any, otherwise generate a new key')
...
def start(listen, data_repo, template_repo, config_repo, config_key, debug, telegram_bot_token, telegram_chat_id, auto_push, auto_push_interval):
    """
